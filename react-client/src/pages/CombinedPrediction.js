...
function CombinedPrediction(props) {
  ...
  let predict = e=>{
    ...
    data.append('uid', props.id);
    data.append("date",date);
    data.append('eye',eye);
    data.append('save',isSave);
    data.append('dioptre1',dioptre_1);
    data.append('dioptre2',dioptre_2);
    data.append('astigmatism',astigmatism);
    data.append('phakic',phakic);
    data.append('gender',gender);
    data.append('age',age);
    data.append('pneumatic',pneumatic);
    data.append('perkins',perkins);
    data.append('pachymetry',pachymetry);
    data.append('axiallength',axialLength);
    data.append('vfmd',vfmd);

    fetch('/combinedpredict', {
      method: 'POST',
      body: data,
    }).then(resp => {
      resp.json().then(data => {
...
export default CombinedPrediction